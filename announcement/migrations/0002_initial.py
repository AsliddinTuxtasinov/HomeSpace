...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='posts',
            name='district',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='announcement.districts'),
        ),
        migrations.AddField(
            model_name='posts',
            name='owner',
        ...
        migrations.AddField(
            model_name='posts',
            name='region',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='announcement.regions'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='postcomment',
            name='parent',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='announcement.postcomment'),
        ),
        migrations.AddField(
            model_name='postcomment',
            name='post',
