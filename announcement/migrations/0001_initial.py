# Generated by Django 3.2.5 on 2021-08-19 20:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(upload_to='announcement/%Y/%m/%d/%H/announcement')),
                ('picture2', models.ImageField(blank=True, null=True, upload_to='announcement/%Y/%m/%d/%H/announcement')),
                ('picture3', models.ImageField(blank=True, null=True, upload_to='announcement/%Y/%m/%d/%H/announcement')),
                ('beds', models.IntegerField(default=1, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(5)], verbose_name='badroom')),
                ('baths', models.IntegerField(default=1, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(5)], verbose_name='batheroom')),
                ('garages', models.IntegerField(default=1, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)], verbose_name='garages')),
